...
IMSI-Catcher GSM menu — simple_IMSI-catcher, livemon, Wireshark
...
```bash
git clone https://github.com/willlccasey/kali-imsi-catcher.git
cd kali-imsi-catcher
./install.sh
```
...
```bash
gh repo clone willlccasey/kali-imsi-catcher
cd kali-imsi-catcher && ./install.sh
```
